...
intentMap.set("Servicebot", identify_user);
intentMap.set("Servicebot - custom", custom_payload);
intentMap.set("Servicebot - custom - custom", report_issue);
